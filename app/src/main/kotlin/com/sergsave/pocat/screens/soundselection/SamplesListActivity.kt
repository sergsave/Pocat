...
class SamplesListActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView(savedInstanceState: Bundle?) {
        ...
        val viewModel: SamplesListViewModel by viewModels {
            (application as MyApplication).appContainer.provideSamplesListViewModelFactory()
        }

        val samples = viewModel.samples.map { Pair(it.second, it.first) }
